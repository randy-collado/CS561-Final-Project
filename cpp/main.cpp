...
int main(int argc, char** argv){
    ...
    std::cout << "Runtime for single-thread implementation: " << runtime.count() / 3.0 << "ms\n";
    {
    ...
    outputs.push_back(b);
    outputs.push_back(c);
    std::chrono::duration<double, std::milli> runtime2 = end2 - start2;
    std::cout << "Runtime for OpenMP implementation: " << runtime2.count() / 3.0 << "ms\n";
